// License:
// 	Kitty/Source/KittyHighScyndi.cpp
// 	Kitty High Scyndi Programming Language
// 	version: 25.01.06
// 
// 	Copyright (C) 2019, 2020, 2023, 2024, 2025 Jeroen P. Broks
// 
...
namespace Slyvina {
    namespace Kitty {
        void KittyHighScyndi() {
            ...
            _KittyHigh::Langs["scyndi"] = Me.Base;
            Me.Base->Language = "Scyndi";            
            auto BaseTypes{ Me.BaseTypes };
            auto KeyWords{ Me.KeyWords };
            KeyWords->push_back("void");
            BaseTypes->push_back("string");
            BaseTypes->push_back("int");
            BaseTypes->push_back("number");
